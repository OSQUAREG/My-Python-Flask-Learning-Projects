# $ pip install apiflask  # this also installs other Flask packages.
# $ pip install python-dotenv  # to access/use the .env and .flaskenv files
# use http://localhost:5000/docs to test the API. Postman can also be used.
...
# Delete Task
@app.delete("/task/delete/<int:task_id>")
