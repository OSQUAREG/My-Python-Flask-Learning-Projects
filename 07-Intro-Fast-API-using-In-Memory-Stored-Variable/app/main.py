...
def update_post(id:int, post: Post):
    ...
    post_dict = post.dict() # receives, converts and assigns posts data entered using the Post schema to dict.
    post_dict["id"] = id # assign the id as well.
    my_posts[index] = post_dict # save the post changes to the my_posts index.
